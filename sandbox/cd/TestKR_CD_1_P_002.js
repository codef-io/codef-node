...
// 카드 개인 승인내역
var approval_list_path = '/v1/kr/card/p/account/approval-list'
...
var codef_api_body = {
  ...
  "organization": "0309",                   // 기관코드(https://developer.codef.io "은행 목록" 참조)
  "birthDate": "",
  "startDate": "20190601",
  "endDate": "20190619",
  "orderBy": "0",
...
var authTokenCallback = function(response) {
  ...
  response.on('end', function() {
    ...
    if (response.statusCode == 200) {
      ...
      // CODEF API 요청
      httpSender(CODEF_URL + approval_list_path, token, codef_api_body);
    } else {
      console.log('토큰발급 오류')
    }
  });
